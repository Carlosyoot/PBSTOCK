...
class Ui_FrmAdmin(object):
    def setupUi(self, FrmAdmin):
        ...
        self.bara_menu_esquerda.setStyleSheet("background-color: rgb(0, 0, 127);")
...
"}")
        ...
        self.btn_colaboradores.setIcon(icon5)
...
"}")
        ...
        self.btn_vendas_2.setIcon(icon7)
        self.btn_vendas_2.setIconSize(QtCore.QSize(65, 50))
...
"de gerenciar estoque!"))
        ...
        self.checkBox_finalizar_app_2.setText(_translate("FrmAdmin", "Salvar no Excel ao Finalizar"))
        ...
        item.setText(_translate("FrmAdmin", "Dia/Hora"))
        item = self.tabela_monitoramento.horizontalHeaderItem(4)
        item.setText(_translate("FrmAdmin", "Valor Dia"))
